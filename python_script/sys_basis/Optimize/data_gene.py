...
class DataGene:
    ...
    @staticmethod
    def plot_charging_schedule(his_usage_before: list, his_usage_after: list):
        """
        ...
        plt.plot(time_slots, his_usage_before, label='Before Optimization', color='b', linestyle='--', marker='o')
        plt.plot(time_slots, his_usage_after, label='After Optimization', color='g', linestyle='-', marker='s')
...
if __name__ == "__main__":
    ...
    # [time_split, eprices_split, max_power_split] = DataGene.split_time(start, start+timedelta(hours=2), eprices, his_usage, 16000, 12800, 2400)
