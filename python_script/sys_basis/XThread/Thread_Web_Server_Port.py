...
from sys_basis.Web_Server.Web_Server import WebServer


class WebServerPort(Thread):
    def __init__(self, host, port, info_title='Web_Server_Port'):
        super().__init__()
        ...
        self.__web_server = WebServer(host, port)
