...
class OCPPServerPort(Thread):
    ...
    def __init__(self, uri: str, charge_point_name: str, charge_point_version: str = 'v2.0.1', info_title: str = 'OCPP Server'):
        super().__init__()
        ...
        self.__websocket = WebSocketServer(uri)
