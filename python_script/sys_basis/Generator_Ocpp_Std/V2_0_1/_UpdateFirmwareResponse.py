...
class GenUpdateFirmwareResponse(Base_OCPP_Struct_V2_0_1):

    @staticmethod
    def generate(
        status: str | UpdateFirmwareStatusType,
        ...
        - Args: 
            - status(str): 
                ...
                - Or use EnumClass (Recommended): `UpdateFirmwareStatusType`. e.g. `UpdateFirmwareStatusType.accepted`
