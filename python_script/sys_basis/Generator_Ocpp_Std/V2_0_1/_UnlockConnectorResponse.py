...
class GenUnlockConnectorResponse(Base_OCPP_Struct_V2_0_1):

    @staticmethod
    def generate(
        status: str | UnlockStatusType,
        ...
        - Args: 
            - status(str): 
                ...
                - Or use EnumClass (Recommended): `UnlockStatusType`. e.g. `UnlockStatusType.unlocked`
