...
class GenClearCacheResponse(Base_OCPP_Struct_V2_0_1):

    @staticmethod
    def generate(
        status: str | ClearCacheStatusType,
        ...
        - Args: 
            - status(str): 
                ...
                - Or use EnumClass (Recommended): `ClearCacheStatusType`. e.g. `ClearCacheStatusType.accepted`
