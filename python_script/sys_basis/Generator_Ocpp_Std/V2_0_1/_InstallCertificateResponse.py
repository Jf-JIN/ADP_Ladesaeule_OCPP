...
class GenInstallCertificateResponse(Base_OCPP_Struct_V2_0_1):

    @staticmethod
    def generate(
        status: str | InstallCertificateStatusType,
        ...
        - Args: 
            - status(str): 
                ...
                - Or use EnumClass (Recommended): `InstallCertificateStatusType`. e.g. `InstallCertificateStatusType.accepted`
