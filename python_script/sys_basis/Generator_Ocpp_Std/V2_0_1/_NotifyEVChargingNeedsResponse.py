...
class notify_ev_charging_needs_response(Base_OCPP_Struct_V2_0_1):
    ...
    @staticmethod
    def generate(status: NotifyEVChargingNeedsStatusType | str, custom_data: dict | None = None, status_info: dict | None = None, **kwargs) -> call_result.NotifyEVChargingNeeds:
        """
        生成 NotifyEVChargingNeedsResponse

        参数:
        - status(str): 状态, 可使用NotifyEVChargingNeedsStatusType枚举类或使用可选值: `Accepted`, `Rejected`, `Processing`
