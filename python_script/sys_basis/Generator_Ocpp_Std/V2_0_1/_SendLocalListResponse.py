...
class GenSendLocalListResponse(Base_OCPP_Struct_V2_0_1):

    @staticmethod
    def generate(
        status: str | SendLocalListStatusType,
        ...
        - Args: 
            - status(str): 
                ...
                - Or use EnumClass (Recommended): `SendLocalListStatusType`. e.g. `SendLocalListStatusType.accepted`
