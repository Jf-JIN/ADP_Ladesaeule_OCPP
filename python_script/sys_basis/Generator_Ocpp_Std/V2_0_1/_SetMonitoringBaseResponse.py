...
class GenSetMonitoringBaseResponse(Base_OCPP_Struct_V2_0_1):
    ...
    def generate(
        ...
        """
        Generate SetMonitoringBaseResponse
    ...
    @staticmethod
    def load_dict(dict_data: dict) -> call_result.SetMonitoringBase:
        """
