...
class GenCancelReservationResponse(Base_OCPP_Struct_V2_0_1):

    @staticmethod
    def generate(
        status: str | CancelReservationStatusType,
        ...
        - Args: 
            - status(str): 
                ...
                - Or use EnumClass (Recommended): `CancelReservationStatusType`. e.g. `CancelReservationStatusType.accepted`
