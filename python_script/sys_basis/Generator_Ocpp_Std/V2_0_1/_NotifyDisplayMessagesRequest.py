...
class GenNotifyDisplayMessagesRequest(Base_OCPP_Struct_V2_0_1):
    ...
    def generate(
        ...
        """
        Generate NotifyDisplayMessagesRequest
        ...
        - Args: 
            ...
            - message_info(list|None): 
                ...
                - recommended to use `get_message_info()` to set element or to build a custom list.
            - tbc(bool|None): 
