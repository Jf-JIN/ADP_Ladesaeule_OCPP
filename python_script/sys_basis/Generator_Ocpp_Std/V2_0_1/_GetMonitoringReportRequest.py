...
class GenGetMonitoringReportRequest(Base_OCPP_Struct_V2_0_1):
    ...
    def generate(
        ...
        """
        Generate GetMonitoringReportRequest
        ...
        - Args: 
            ...
            - monitoring_criteria(list|None): 
                - length limit: [1, 3]
                - recommended to use `get_monitoring_criteria()` to set element or to build a custom list.
