...
class ControlTextBrowser(QWidget):
    ...
    def append_text(self, text_on_textbrowser: str) -> None:
        ...
        try:
            if self.__text_browser.verticalScrollBar().value() != self.__text_browser.verticalScrollBar().maximum():
                ...
                self.__text_browser.moveCursor(QTextCursor.End)
    ...
    def __init__(self,
                 ...
                 flag_scrollbar_display: bool = False,
    ...
    def __widget_init(self):
        ...
        if self.__flag_button_in_textbrowser:
            ...
            self.__text_browser.setStyleSheet(
                f"""QTextBrowser{{border: None;color: {self.__font_color};}}""")
        else:
        ...
        self.__text_browser.setFont(font)
        self.__pb_list = [self.__pb_up, self.__pb_down, self.__pb_font_size_increase, self.__pb_font_size_decrease, self.__pb_reset, self.__pb_clear]
...
if __name__ == "__main__":
    ...
    main_window = ControlTextBrowser(background_color='#000088', flag_button_in_textbrowser=False, buttons_position='right')
