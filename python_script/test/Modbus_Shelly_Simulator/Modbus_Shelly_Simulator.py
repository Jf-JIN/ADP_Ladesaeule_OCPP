    ...
    def check_json_file(self):
        if os.path.exists(JSON_FILE_PATH):
            ...
            try:
                ...
                self.onoff_selftest_1004 = int(json_dict.get('1004', 0))
                self.configured_amps_1000 = int(json_dict.get('1000', 0))
                self.charge_operation_2005 = int(json_dict.get('2005', 0))
